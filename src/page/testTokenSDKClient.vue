...
export default {
  ...
  data () {
    return {
      ...
      pvDataAdid: {
        ...
        superDid: 'did:ttm:u043829681e922731094502ebffdf1f10389c3ad11c8a67847c68f0482e608',
        relationDid: '',
        contacts: [],
        property: {
          name: '微信',
  ...
  methods: {
    ...
    opServerPvdata () {
      let keys = tokenSDKClient.sm2.genKeyPair(this.didttm.prikey)
      // console.log('keys', keys, JSON.stringify(this.pvDataAdid))
      let ct = keys.encrypt(JSON.stringify(this.pvDataAdid))
      console.log('ct', ct, `[${ct.join(', ')}]`)
