<template>
  <div class="webSocket">
    <h2>基本样式</h2>
    <!-- <basicvue></basicvue> -->
    <textarea name="" id="" cols="30" rows="10" v-model="pdid" placeholder="请输入did"></textarea>
    <br>
...
export default {
  ...
  methods: {
    ...
    sendMessage (cont = this.cont) {
      ...
      this.ws.send(this.createMessage(cont))
    },
    createMessage (content = '', receiver = [], type = 'message', messageId = [], createTime = new Date().getTime()) {
